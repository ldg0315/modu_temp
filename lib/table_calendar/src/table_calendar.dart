...
class TableCalendar<T> extends StatefulWidget {
  ...
  /// Use built-in `DateTime` weekday constant (e.g. `DateTime.monday`) instead of `int` literals (e.g. `1`).
                ...
                dowCell = Center(
                  child: ExcludeSemantics(
                    child: Text(
                      weekdayString,
                      style: isSaturday
                          ? widget.daysOfWeekStyle.saturdayStyle : isWeekend ? widget.daysOfWeekStyle.sundayStyle
  ...
  Widget _buildCell(DateTime day, DateTime focusedDay) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final isSaturday = _isSaturday(day);
