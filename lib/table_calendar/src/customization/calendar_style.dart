...
class CalendarStyle {
  ...
  const CalendarStyle({
    ...
    this.sundayTextStyle = const TextStyle(color: const Color(0xFFCB0931), fontWeight: FontWeight.bold),
    this.saturdayTextStyle = const TextStyle(color: const Color(0xFF0928C7), fontWeight: FontWeight.bold),
    // this.weekendDecoration = const BoxDecoration(shape: BoxShape.circle),
    this.sundayDecoration = const BoxDecoration(shape: BoxShape.circle),
    this.saturdayDecoration = const BoxDecoration(shape: BoxShape.circle),
    this.defaultTextStyle = const TextStyle(fontWeight: FontWeight.bold),
